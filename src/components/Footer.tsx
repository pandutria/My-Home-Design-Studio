...
import whatsaapWhite from '../../public/images/icon/whatsaa_white.png'
import emailWhite from '../../public/images/icon/email_white.png'

const Footer = () => {
  return (
    <div>
      <section className='flex w-full justify-center bg-thrdtinary'>
        <div className='container flex flex-col lg:w-250 md:w-full w-full lg:px-0 md:px-5 px-5 lg:py-15 md:py-15 py-5 lg:gap-10 md:gap-10 gap-5'>
          <div className='flex flex-row w-full items-start justify-between'>
            <img src={logo} className='lg:flex md:flex hidden lg:w-25 md:w-15 w-25 h-auto object-contain' alt="" />
            ...
            <h1 className='font-poppins font-semibold text-white lg:text-[16px] md:text-[13px]'>Media Sosial</h1>
              <div className='flex flex-row lg:gap-5 md:gap-4 gap-4 lg:mt-2 md:mt-2 mt-0'>
                ...
                <img src={emailWhite} className='lg:w-5 md:w-4 w-8 lg:h-5 md:h-4 h-8 object-contain' alt="" />
                <img src={youtube} className='lg:w-5 md:w-4 w-8 lg:h-5 md:h-4 h-8 object-contain' alt="" />
                <img src={whatsaapWhite} className='lg:w-5 md:w-4 w-8 lg:h-5 md:h-4 h-8 object-contain' alt="" />
              </div>
            </div>
          </div>
          <hr className='lg:flex md:flex hidden w-full border-[1.5px] border-white/15 mt-5' />
