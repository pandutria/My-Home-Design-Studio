...
const Home = () => {
  return (
    <div>
      <section className='flex w-full lg:h-screen justify-center items-center bg-white lg:pt-[9vh] md:pt-[9vh] pt-[10vh]'>
        <div className='container flex flex-row lg:w-250 md:w-full w-full lg:px-0 md:px-5 px-5 lg:pt-0 md:pt-15 pt-8 justify-between items-start'>
          <img src={homeImg} className='lg:flex md:flex hidden lg:w-100 md:w-80 h-auto object-contain' alt="" />
          <div className='flex flex-col lg:w-140 md:w-95 w-full lg:gap-1 md:gap-2 gap-2'>
